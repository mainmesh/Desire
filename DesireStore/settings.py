...
ALLOWED_HOSTS = ["desire-pybt.onrender.com", "localhost", "127.0.0.1"]
...
JAZZMIN_SETTINGS = {
    ...
    "welcome_sign": "Welcome Desire",

    # Copyright on the footer
    "copyright": "Desire Ltd",
...
WSGI_APPLICATION = 'DesireStore.wsgi.application'
